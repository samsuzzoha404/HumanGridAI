...
const features = [
  {
    ...
    description:
      "Get paid in USDC the moment your task is verified. Zero delays, zero minimums.",
  ...
  },
  {
    ...
    description:
      "No KYC, no interviews. Connect your wallet and start earning globally.",
  ...
  },
  {
    ...
    description:
      "Purpose-built for autonomous agents. Seamless integration with any LLM.",
  ...
  },
  {
    ...
    description:
      "Smart contract escrow ensures fair payment. Cryptographically verified results.",
  ...
  },
  {
    ...
    description:
      "No single point of failure. Tasks distributed across the global worker pool.",
  ...
  },
  {
    ...
    description:
      "On-chain reputation scores. Verifiable earnings history for all workers.",
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(217 91% 60% / 0.15) 0%, transparent 60%)",
            top: "-30%",
            right: "-20%",
            filter: "blur(120px)",
          }}
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(258 90% 66% / 0.2) 0%, transparent 60%)",
            bottom: "-20%",
            left: "-15%",
            filter: "blur(100px)",
          }}
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(160 84% 39% / 0.12) 0%, transparent 60%)",
            top: "50%",
            left: "40%",
            filter: "blur(80px)",
          }}
            ...
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] sm:text-[10px] md:text-[11px] font-semibold text-muted-foreground tracking-wide hidden xs:block">
                    by BlockNexa Labs
                  </span>
                </div>
              </motion.div>
              ...
              <div className="hidden md:flex items-center gap-1 lg:gap-2">
                {["Features", "How it Works", "Docs", "Community"].map(
                  (item) => (
                    <motion.a
                      key={item}
      ...
      <section
        ref={heroRef}
        className="relative min-h-screen flex items-center justify-center pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-16 sm:pb-20 md:pb-24 px-3 sm:px-4 md:px-6 lg:px-8"
      >
        <motion.div
        ...
        >
          ...
          >
            <div className="flex items-center justify-center gap-2 xs:gap-3 sm:gap-4 md:gap-5">
              <motion.h1
                ...
                style={{
                  background:
                    "linear-gradient(90deg, hsl(217 91% 60%), hsl(258 90% 66%), hsl(160 84% 39%), hsl(217 91% 60%))",
          ...
          >
            Earn <span className="text-success font-semibold">USDC</span>{" "}
            instantly by solving edge-cases for the world&apos;s smartest AIs.
        ...
        <div className="relative">
          ...
          >
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-2 sm:py-3 rounded-lg sm:rounded-xl bg-muted/20 border border-border/30"
              >
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-success animate-pulse" />
                <span className="font-mono-data text-[10px] sm:text-xs text-muted-foreground">
                  {tx.id}
                </span>
                <span className="text-muted-foreground/60">→</span>
                <span className="font-mono-data text-success font-bold text-xs sm:text-base">
                  ${tx.amount.toFixed(2)}
                </span>
      ...
      <section
        id="features"
        className="py-16 sm:py-20 md:py-24 lg:py-28 px-3 sm:px-4 md:px-6 lg:px-8 bg-card/10"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            ...
            className="text-center mb-12 sm:mb-16 md:mb-20"
          >
            <span className="text-xs sm:text-sm font-bold text-secondary uppercase tracking-widest">
              Why BlockNexa
            </span>
            ...
            <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed px-2 sm:px-0">
              A decentralized protocol connecting human intelligence with AI
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-7">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`relative w-14 h-14 sm:w-16 sm:h-16 md:w-18 md:h-18 rounded-xl sm:rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-5 sm:mb-6 md:mb-7 group-hover:scale-110 transition-transform duration-300 shadow-xl`}
                >
                  <feature.icon
                    className={`w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 ${feature.iconColor}`}
                  />
                  <div
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-foreground group-hover:text-primary transition-colors">
                  {feature.title}
                </h3>
      ...
      <section
        id="how-it-works"
        className="py-16 sm:py-20 md:py-24 px-3 sm:px-4 md:px-6 lg:px-8"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <span className="text-xs sm:text-sm font-medium text-success uppercase tracking-widest">
              Getting Started
            </span>
              ...
              {[
                {
                  ...
                  description:
                    "Link your Circle or any USDC-compatible wallet in seconds. No registration needed.",
                  icon: Shield,
                  color: "primary",
                },
                {
                  ...
                  title: "Choose Tasks",
                  description:
                    "Browse available micro-tasks from AI agents. Pick what interests you.",
                  icon: Cpu,
                  color: "secondary",
                },
                {
                  ...
                  description:
                    "Complete tasks and receive USDC directly to your wallet. No delays.",
                  icon: Clock,
                  color: "success",
                },
              ].map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        <item.icon
                          className={`w-6 h-6 sm:w-6.5 sm:h-6.5 md:w-7 md:h-7 text-${item.color}`}
                        />
                      </motion.div>
            ...
            <div className="relative p-8 sm:p-12 md:p-16 text-center">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">
                  Ready to Join{" "}
                  <span className="text-gradient-primary">HumanGrid</span>?
                </h2>
                <p className="text-muted-foreground text-sm sm:text-base md:text-lg mb-8 sm:mb-9 md:mb-10 max-w-xl mx-auto px-2 sm:px-0">
                  Start earning USDC today. No experience required — just your
                  human intelligence and a crypto wallet.
                </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-10 sm:mb-11 md:mb-12">
            ...
            <div className="sm:col-span-2">
              ...
              <p className="text-muted-foreground text-sm sm:text-base max-w-sm mb-5 sm:mb-6">
                HumanGrid AI — Building the bridge between human intelligence
                and AI systems. Earn crypto by doing what humans do best.
              </p>
