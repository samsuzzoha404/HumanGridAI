    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        >
          ...
          <div className="mt-6 p-4 rounded-xl bg-muted/30 border border-border/30">
            <div className="flex items-center justify-between text-sm mb-2">
              ...
              <span className="text-foreground font-medium font-mono-data">
                {levelProgress}%
              </span>
            </div>
            <Progress value={levelProgress} className="h-2" />
            <p className="text-xs text-muted-foreground mt-2">
              Complete <span className="font-mono-data text-primary">25</span>{" "}
              more tasks to level up
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-3xl font-bold text-foreground font-mono-data">
            {Number(stats.accuracyScore) || 0}%
          </p>
        ...
        >
          ...
          <p className="text-3xl font-bold text-foreground font-mono-data">
            {Number(stats.tasksSolvedToday) || 0}
          </p>
              ...
              >
                <div
                  className={`w-14 h-14 mx-auto mb-2 rounded-xl ${
                    achievement.unlocked ? "bg-muted/50" : "bg-muted/20"
        ...
        >
          {[
            ...
            },
            {
              icon: Shield,
              label: "Security",
              desc: "Two-factor and wallet security",
            },
          ].map((item) => (
            <button
              key={item.label}
